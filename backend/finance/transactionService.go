...
var defaultAccounts = []financeDomain.Account{
	*financeDomain.NewAccount("Account_Player_1", "Player_1", 1_000),
	*financeDomain.NewAccount("Account_Player_2", "Player_2", 1_000),
	*financeDomain.NewAccount("Account_Player_3", "Player_3", 1_000),
	*financeDomain.NewAccount("Account_Player_4", "Player_4", 1_000),
	*financeDomain.NewAccount("Bank", "Bank", 100_000_000),
}
